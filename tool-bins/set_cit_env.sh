...
export FABRIC_CFG_PATH=/workspaces/uninetconsortium/config/cit
# Address of the peer
export CORE_PEER_ADDRESS=cit.natuni.edu:7051
# Local MSP for the admin - Commands need to be executed as org admin
export CORE_PEER_MSPCONFIGPATH=/workspaces/uninetconsortium/config/crypto-config/peerOrganizations/natuni.edu/users/Admin@natuni.edu/msp
